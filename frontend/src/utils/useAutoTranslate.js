...
const CLIENT_GLOSSARY = {
  HI: {
    ...
    'view full schedule →': 'पूरा कार्यक्रम देखें →',
    ...
    'divine photo & video gallery': 'दिव्य तस्वीरें एवं वीडियो संग्रह',
    'divine aarti & utsav schedule': 'दिव्य आरती एवं उत्सव कार्यक्रम',
  ...
  GU: {
    ...
    'view full schedule →': 'સંપૂર્ણ કાર્યક્રમ જુઓ →',
    'read full about us →': 'અમારા વિશે સંપૂર્ણ વિગત વાંચો →',
    'today\'s schedule': 'આજનો કાર્યક્રમ',
    ...
    'divine aarti & utsav schedule': 'દિવ્ય આરતી અને ઉત્સવ કાર્યક્રમ',
